const VERSION='v40.7-user-test-mvp';
...
if('serviceWorker'in navigator){navigator.serviceWorker.register('./namilog-sw.js?v=40.7').catch(()=>{});navigator.serviceWorker.addEventListener('message',e=>{if(e.data?.type==='OPEN_QUICK_CHECK')openQuick()})}
