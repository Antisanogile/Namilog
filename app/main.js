...
if('serviceWorker'in navigator){navigator.serviceWorker.register('./namilog-sw.js?v=40.5').catch(()=>{});navigator.serviceWorker.addEventListener('message',e=>{if(e.data?.type==='OPEN_QUICK_CHECK')openQuick()})}
